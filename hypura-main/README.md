...
## Gemma 4 on 24 GB M4 Pro

This checkout includes a verified Gemma 4 path for Apple Silicon:
...
See [GEMMA4_M4_PRO.md](./GEMMA4_M4_PRO.md) for the tested model file and recommended settings.
