...
pub struct ModelMetadata {
    ...
    pub num_kv_heads_total: Option<u32>,
    pub vocab_size: u32,
...
impl ModelMetadata {
    ...
    pub fn from_gguf(gguf: &GgufFile) -> anyhow::Result<Self> {
        ...
        let num_kv_heads = gguf
            ...
            .or_else(|| gguf.get_u32_array_mean(&format!("{arch}.attention.head_count_kv")))
            .or_else(|| gguf.get_u32_array_mean("attention.head_count_kv"))
            .unwrap_or(num_heads);
        let num_kv_heads_total = gguf
            .get_u32_array_sum(&format!("{arch}.attention.head_count_kv"))
            .or_else(|| gguf.get_u32_array_sum("attention.head_count_kv"));
    ...
    pub fn total_kv_heads(&self) -> u64 {
        self.num_kv_heads_total.map_or_else(
            || self.num_layers as u64 * self.num_kv_heads as u64,
            |total| total as u64,
        )
    }
}
